...
CREATE TABLE SEDE (
  ...
  CONSTRAINT uq_sede_direccion UNIQUE (direccion),
...
CREATE TABLE AULA (
  ...
  CONSTRAINT fk_aula_sede FOREIGN KEY (id_institucion, id_sede)
    REFERENCES SEDE(id_institucion, id_sede)
);
...
CREATE TABLE NOTA_ESTUDIANTE (
  ...
  CONSTRAINT fk_ne_est FOREIGN KEY (id_estudiante)
    REFERENCES ESTUDIANTE(id_estudiante),
  CONSTRAINT fk_ne_periodo FOREIGN KEY (id_periodo)
    REFERENCES PERIODO(id_periodo),
  CONSTRAINT fk_ne_componente FOREIGN KEY (id_componente)
    REFERENCES COMPONENTE(id_componente),
  CONSTRAINT uq_nota_est UNIQUE (id_estudiante, id_componente, id_periodo)
);

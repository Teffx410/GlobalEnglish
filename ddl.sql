...
DROP TABLE TUTOR_AULA CASCADE CONSTRAINTS;
...
CREATE TABLE TUTOR_AULA (
  id_tutor_aula   NUMBER NOT NULL,  -- FK a ASIGNACION_TUTOR
  id_aula         NUMBER NOT NULL,  -- FK a AULA
  CONSTRAINT pk_tutor_aula
    PRIMARY KEY (id_tutor_aula, id_aula),
  CONSTRAINT fk_ta_asignacion
    FOREIGN KEY (id_tutor_aula)
      REFERENCES ASIGNACION_TUTOR(id_tutor_aula),
  CONSTRAINT fk_ta_aula
    FOREIGN KEY (id_aula)
